...
VALUES
 (UNHEX('3f883b26f61b41b0a83f390bfb4b311a'), 'Stefan', 'Stefanovic', 'stefanmatic941@gmail.com', '$2a$10$.pPphHcTYF5iSV/rIMdF0OtfJ0.gJMhCHdTFD3sxCG88LXF8mugim', 2000, 'USER'),
...
INSERT INTO event (id, name, date, location, description, capacity, ticket_price, publisher_id, is_done, comment_count, publisher_email, likes, dislikes)
VALUES
  (UNHEX('8a9b6ac4e3e04824a5436c89a1e31c2e'), 'A event', '2027-11-15', 'Venue A', 'Event description A', 500, 100.00, UNHEX('3f883b26f61b41b0a83f390bfb4b311a'), false, 0, 'stefan@gmail.com', 120, 20),
  (UNHEX('6f885b26f61b41b0a83f390bfb4be11a'), 'B event', '2027-10-02', 'Venue B', 'Event description B', 200, 30.00, UNHEX('3f883b26f61b41b0a83f390bfb4b311a'), false, 0, 'stefan@gmail.com', 50, 20),
  (UNHEX('6f825b26f61b41b0a83f390bfb4be11a'), 'C event', '2027-09-07', 'Venue C', 'Event description C', 300, 70.00, UNHEX('3f883b26f61b41b0a83f390bfb4b311a'), false, 0, 'stefan@gmail.com', 30, 70),
  (UNHEX('9a8b6ac4e3e04824a5436c89a1e31c2e'), 'D Event', '2023-05-20', 'Venue D', 'Event description D', 100, 25.00, UNHEX('3f883b26f61b41b0a83f390bfb4b311a'), true, 3, 'stefan@gmail.com', 70, 10);
