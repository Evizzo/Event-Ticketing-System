...
INSERT INTO review (id, event_id, reviewer_id, comment, date, is_edited, email_of_reviewer)
    VALUES
      (UNHEX('8a9b6ac4e3e04824a5436c89a1e31c2e'), UNHEX('9a8b6ac4e3e04824a5436c89a1e31c2e'), UNHEX('2f883b26f61b41b0a83f390bfb4b311a'), 'Great event!', '2023-05-21', false, 'ema@gmail.com'),
